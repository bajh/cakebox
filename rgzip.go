...
func makeZip() {
	...
	zhead := []byte{
		...
		0x07, 0x00, // flen
		0x00, 0x00, // xlen
		'm', 'a', 'g', 'i', 'c', '_', 'c', //'c', 'a', 'k', 'e', '_', 'b', 'o', 'x', // file name
	}
	head := zhead[5:]
	headsize := head[14:26]
	...
	/*
		...
		b.writeBits(0x00+48, 8, true)
	*/
	b.writeBits('m'+48, 8, true) // file name
	b.writeBits('a'+48, 8, true)
	b.writeBits('g'+48, 8, true)
	b.writeBits('i'+48, 8, true)
	b.writeBits('c'+48, 8, true)
	b.writeBits('_'+48, 8, true)
	b.writeBits('c'+48, 8, true)
	//	b.writeBits('a'+48, 8, true)
	//	b.writeBits('k'+48, 8, true)
	//	b.writeBits('e'+48, 8, true)
	//	b.writeBits('_'+48, 8, true)
	//	b.writeBits('b'+48, 8, true)
	//	b.writeBits('o'+48, 8, true)
	//	b.writeBits('x'+48, 8, true)
...
func (b *wbuf) rep(n int) {
	...
	default:
		panic(fmt.Sprintf("cannot encode REP: %d", n))
	}
...
type ReadError struct {
	...
	e      error // error returned by underlying Read
}

func (e *ReadError) Error() string {
	return "flate: read error at offset " + strconv.FormatInt(e.Offset, 10) + ": " + e.e.Error()
}
...
func (e *WriteError) Error() string {
	return "flate: write error at offset " + strconv.FormatInt(e.Offset, 10) + ": " + e.e.Error()
}
